...
function Main({amount} : num): JSX.Element {
  return (
    <>
          ...
          <div className='cities'>
            <div className='cities__places-container container'>
              <section className='cities__places places'>
                ...
                <b className='places__found'>{amount} places to stay in Amsterdam</b>
                ...
                <div className='cities__places-list places__list tabs__content'>
                  {
                    cards.map(({id,isPremium , src, price, type, cardName}) => <Card key={id} id={id} isPremium={isPremium} src={src} price={price} type={type} cardName={cardName}/>)
                  }
                </div>
              </section>
